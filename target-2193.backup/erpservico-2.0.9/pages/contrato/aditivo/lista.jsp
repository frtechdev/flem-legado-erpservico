            ...
            <div id="content">
                ...
                <html:form action="/Aditivo.do" method="post">
                    ...
                    <display:table id="aditivo" name="aditivos" defaultsort="2" sort="list" export="false" excludedParams="metodo" requestURI="./Aditivo.do" pagesize="30" class="tabelaDisplay">
                        <display:column style="width: 50;"> <input type="checkbox" name="ids_exclusao" value="${aditivo.id}"/></display:column>
                        <display:column property="inicioVigencia" title="Início da Vigência" format="{0,date,dd/MM/yyyy}" style="width: 300;"/>
                        <display:column property="fimVigencia" title="Fim da Vigência" format="{0,date,dd/MM/yyyy}" style="width: 300;"/>
