...
<html>
    ...
    <body>
        ...
        <div id="wrap">
            ...
            <div id="content">
                <h2>Lista Autônomos Inconsistentes - GEM</h2>
                <display:table id="entidade" name="lista" defaultsort="1" sort="list" export="false" excludedParams="metodo" requestURI="/Autonomo.do?metodo=inconsistentes" pagesize="50" class="tabelaDisplay" >
