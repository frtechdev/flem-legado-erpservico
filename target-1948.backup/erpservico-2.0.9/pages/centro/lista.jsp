...
<html> 
    ...
    <body>
        ...
        <div id="wrap">
            ...
            <div id="content">
                <h2>Consulta</h2>
                <html:form action="/CentroCusto.do?metodo=listar" onsubmit="return validaForm();">
                    <table>
                        <tr>
                 ...
                 <display:table id="item" name="lista" sort="list" export="true" requestURI="/FonteRecurso.do" class="tabelaDisplay" pagesize="20" >
                    ...
                    <display:column title="detalhe" href="./FonteRecurso.do?metodo=detalhar&'${codigoFonteRecurso}'&'${dataIniio}'&'${dataFim}'" paramId="id" paramProperty="id" ><img align="middle" src="img/edit.png" width="22" height="22" border="0" alt="editar"/></display:column>
                </display:table>
