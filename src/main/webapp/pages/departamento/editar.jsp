    ...
    <head>
        ...
        <script>
            function setCamposDepartamento(dadosDepartamento){
                ...
                $("nom_dept").value = dados[0];
                $("cod_lotacao_hr").value = dados[1];
            }
        </script>
    ...
    <body>
        ...
        <div id="wrap">
            ...
            <div id="content">
                ...
                <html:form action="/Departamento.do?metodo=alterar" onsubmit="return validar(this);" method="post" enctype="multipart/form-data" >
                    <html:hidden property="departamento.id" />

                    <table border="0" width="100%">
                        <tr bgcolor="#EEEEEE">
                            <td colspan="2"><strong>Departamentos HR</strong></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2">
                                Lotação HR:<br />
                                <html:text property="departamento.cod_lotacao_hr" styleId="nom_dept" size="30" style="background-color:#DDDDDD;"/> 
                        ...
                        <tr>
                            <td colspan="2">
                                Nome:<br />
                                <html:text property="departamento.nom_dept" styleId="nom_dept" size="30" style="background-color:#DDDDDD;"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Código do Centro de Custo<br />
                                <html:select property="departamento.cod_ccusto" styleId="cod_ccusto" style="width: 300px;">
                                    <html:option value="">-- Selecione --</html:option>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <html:select property="departamento.cod_cresp" styleId="cod_crespId" style="width: 300px;">
                                    <html:option value="">-- Selecione --</html:option>
