...
@Entity
public class Caixa extends BaseDTOAb {
    ...
    public String toLayout() {
        final StringBuffer linha = IOUtil.linhaVazia(519);
        ...
        linha.replace(526, 544, String.valueOf(this.rendaLiquida));
        linha.replace(545, 547, this.codBanco);
        linha.replace(548, 551, this.agencia);
        linha.replace(552, 554, this.op);
        linha.replace(555, 5168, this.conta);
        linha.replace(569, 570, this.digito);
        return linha.substring(0, 517);
    }
